...
// A 'reddish' függvény megakadályozza, hogy ugyanazon csapat bábuit egymás után törölje.
function reddish() {
...
// Tog változó a játékosok váltogatására, fehér és fekete sakkirányokat figyeli.
tog = 1
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        // Funkció ami megjeleníti az összes elérhető útvonalát.
        ...
        // Fordulat váltás (Éppen fekete, vagy fehér következik).
...
// A 'z' változó megakadályozza, hogy több mezőt egyszerre lehessen kijelölni.
z = 0
